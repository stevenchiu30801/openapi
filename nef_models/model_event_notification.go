...
type EventNotification struct {
	...
	SourceTrafficRoute *RouteToLocation `json:"sourceTrafficRoute,omitempty" bson:"sourceTrafficRoute"`

	SubscribedEvent SubscribedEvent `json:"subscribedEvent" bson:"subscribedEvent"`

	TargetTrafficRoute *RouteToLocation `json:"targetTrafficRoute,omitempty" bson:"targetTrafficRoute"`
