...
type LocationArea5G struct {
	...
	GeographicAreas []GeographicArea `json:"geographicAreas,omitempty" bson:"geographicAreas"`

	// Identifies a list of civic addresses of the user where the UE is located.
	CivicAddresses []CivicAddress `json:"civicAddresses,omitempty" bson:"civicAddresses"`
